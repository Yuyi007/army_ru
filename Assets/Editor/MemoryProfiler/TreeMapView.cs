...
namespace MemoryProfilerWindow
{
    public class TreeMapView
    {
        ...
        private Dictionary<string, MemoryProfilerTreemap.Group> _groups = new Dictionary<string, MemoryProfilerTreemap.Group>();
        private List<Item> _items = new List<Item>();
        private List<Mesh> _cachedMeshes = new List<Mesh>();
        private Item _selectedItem;
        private MemoryProfilerTreemap.Group _selectedGroup;
