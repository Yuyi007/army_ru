...
fixed4 frag_surface(v2f i): SV_Target
{
    ...
    fixed3 diffuse = _Color.rgb * albedo * saturate(dot(worldNormal, worldLight));
    fixed3 specular = _Color.rgb * _Specular.rgb * pow(saturate(dot(worldNormal, worldHalf)), _Shininess);
