    ...
    public class Bloom : PostEffectsBase
    {
        ...
        public override bool CheckResources ()
        {
            ...
            if ( lensFlareShader == null )
                lensFlareShader = (Shader) Shader.Find ("Hidden/LensFlareCreate");

            if ( screenBlendShader == null )
                screenBlendShader = (Shader) Shader.Find ("Hidden/BlendForBloom");

            if ( blurAndFlaresShader == null )
                blurAndFlaresShader = (Shader) Shader.Find ("Hidden/BlurAndFlares");

            if ( brightPassFilterShader == null )
                brightPassFilterShader = (Shader) Shader.Find ("Hidden/BrightPassFilter2");
