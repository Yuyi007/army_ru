...
#pragma warning restore 414
    ...
    public partial class LuaDLL
    {
        ...
        const string SLUADLL = "slua";
#elif UNITY_IPHONE
		const string LUADLL = "__Internal";
        const string SLUADLL = "__Internal";
#else
        const string LUADLL = "luajit";
        const string SLUADLL = "slua";
#endif
        ...
        public static extern int luaS_indexfun(IntPtr l);

        [DllImport(SLUADLL, CallingConvention = CallingConvention.Cdecl)]
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        public static extern int luaS_newindexfun(IntPtr l);
    }
}
