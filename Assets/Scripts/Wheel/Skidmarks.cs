...
public class Skidmarks : MonoBehaviour {
	...
	[SerializeField]
	public int MAX_MARKS = 128; // Max number of marks total for everyone together
	[SerializeField]
	public float MARK_WIDTH = 0.5f; // Width of the skidmarks. Should match the width of the wheels
	[SerializeField]
	public float GROUND_OFFSET = 0.02f;  // Distance above surface in metres
	[SerializeField]
	public float SHOW_MARK_TIME = 2f;  // 
	...
	public int AddSkidMark(Vector3 pos, Vector3 normal, float intensity, int lastIndex) {
        ...
        curSection.CreateTime = Time.time;
        if (lastIndex != -1) {
