...
namespace UnityChan
{
	public class SpringBone : MonoBehaviour
	{
        ...
        public Vector3 baseSpringForce = new Vector3 (0.0f, -0.0001f, 0.0f);
		...
		{
            Vector3 worldSpaceSpringForce = managerRef.transform.TransformVector(springForce);
            ...
            force += worldSpaceSpringForce / sqrDt;
