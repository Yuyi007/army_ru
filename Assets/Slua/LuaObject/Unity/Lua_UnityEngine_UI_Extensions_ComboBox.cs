...
public class Lua_UnityEngine_UI_Extensions_ComboBox : LuaObject {
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.UI.Extensions.ComboBox");
		addMember(l,Awake);
		...
		createTypeMetatable(l,null, typeof(UnityEngine.UI.Extensions.ComboBox),typeof(UnityEngine.MonoBehaviour));
	}
}
