...
public class Lua_UnityEngine_UI_Extensions_HorizontalScrollSnap : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int NextScreen(IntPtr l) {
		try {
			UnityEngine.UI.Extensions.HorizontalScrollSnap self=(UnityEngine.UI.Extensions.HorizontalScrollSnap)checkSelf(l);
			self.NextScreen();
			return 0;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.UI.Extensions.HorizontalScrollSnap");
		...
		createTypeMetatable(l,null, typeof(UnityEngine.UI.Extensions.HorizontalScrollSnap),typeof(UnityEngine.MonoBehaviour));
	}
}
