...
public class Lua_UnityEngine_UI_Extensions_ImageExtended : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int OnBeforeSerialize(IntPtr l) {
		try {
			UnityEngine.UI.Extensions.ImageExtended self=(UnityEngine.UI.Extensions.ImageExtended)checkSelf(l);
	...
	static public int set_type(IntPtr l) {
		try {
			UnityEngine.UI.Extensions.ImageExtended self=(UnityEngine.UI.Extensions.ImageExtended)checkSelf(l);
			UnityEngine.UI.Extensions.ImageExtended.Type v;
			checkEnum(l,2,out v);
			self.type=v;
			return 0;
		}
	...
	static public int set_fillMethod(IntPtr l) {
		try {
			UnityEngine.UI.Extensions.ImageExtended self=(UnityEngine.UI.Extensions.ImageExtended)checkSelf(l);
			UnityEngine.UI.Extensions.ImageExtended.FillMethod v;
			checkEnum(l,2,out v);
			self.fillMethod=v;
			return 0;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_rotate(IntPtr l) {
		try {
			UnityEngine.UI.Extensions.ImageExtended self=(UnityEngine.UI.Extensions.ImageExtended)checkSelf(l);
			pushEnum(l,(int)self.rotate);
			return 1;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_rotate(IntPtr l) {
		try {
			UnityEngine.UI.Extensions.ImageExtended self=(UnityEngine.UI.Extensions.ImageExtended)checkSelf(l);
			UnityEngine.UI.Extensions.ImageExtended.Rotate v;
			checkEnum(l,2,out v);
			self.rotate=v;
			return 0;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.UI.Extensions.ImageExtended");
		...
		addMember(l,"rotate",get_rotate,set_rotate,true);
		...
		createTypeMetatable(l,null, typeof(UnityEngine.UI.Extensions.ImageExtended),typeof(UnityEngine.UI.MaskableGraphic));
	}
}
