...
public class Lua_PostProcessCtrl : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int DoRefresh(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			self.DoRefresh();
			return 0;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_boBloomOptEnable(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			pushValue(l,self.boBloomOptEnable);
			return 1;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_boBloomOptEnable(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			System.Boolean v;
			checkType(l,2,out v);
			self.boBloomOptEnable=v;
			return 0;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_boThreshold(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			pushValue(l,self.boThreshold);
			return 1;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_boThreshold(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			System.Single v;
			checkType(l,2,out v);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_boIntensity(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			pushValue(l,self.boIntensity);
			return 1;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_boIntensity(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			System.Single v;
			checkType(l,2,out v);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_boBlurSize(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			pushValue(l,self.boBlurSize);
			return 1;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_boBlurSize(IntPtr l) {
		try {
			PostProcessCtrl self=(PostProcessCtrl)checkSelf(l);
			System.Single v;
			checkType(l,2,out v);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"PostProcessCtrl");
		...
		addMember(l,"boBloomOptEnable",get_boBloomOptEnable,set_boBloomOptEnable,true);
		addMember(l,"boThreshold",get_boThreshold,set_boThreshold,true);
		addMember(l,"boIntensity",get_boIntensity,set_boIntensity,true);
		addMember(l,"boBlurSize",get_boBlurSize,set_boBlurSize,true);
		...
		createTypeMetatable(l,null, typeof(PostProcessCtrl),typeof(UnityEngine.MonoBehaviour));
	}
}
