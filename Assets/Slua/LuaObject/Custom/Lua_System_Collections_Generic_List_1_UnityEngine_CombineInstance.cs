...
public class Lua_System_Collections_Generic_List_1_UnityEngine_CombineInstance : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<UnityEngine.CombineInstance> o;
			if(argc==1){
				o=new System.Collections.Generic.List<UnityEngine.CombineInstance>();
				pushValue(l,o);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<UnityEngine.CombineInstance>))){
				System.Collections.Generic.IEnumerable<UnityEngine.CombineInstance> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<UnityEngine.CombineInstance>(a1);
				pushValue(l,o);
				return 1;
			}
	...
	static public int Add(IntPtr l) {
		try {
			System.Collections.Generic.List<UnityEngine.CombineInstance> self=(System.Collections.Generic.List<UnityEngine.CombineInstance>)checkSelf(l);
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				UnityEngine.CombineInstance a1;
				checkValueType(l,2,out a1);
				System.Collections.Generic.IComparer<UnityEngine.CombineInstance> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				UnityEngine.CombineInstance a3;
				checkValueType(l,4,out a3);
				System.Collections.Generic.IComparer<UnityEngine.CombineInstance> a4;
	...
	static public int Exists(IntPtr l) {
		try {
			System.Collections.Generic.List<UnityEngine.CombineInstance> self=(System.Collections.Generic.List<UnityEngine.CombineInstance>)checkSelf(l);
			System.Predicate<UnityEngine.CombineInstance> a1;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				System.Predicate<UnityEngine.CombineInstance> a2;
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<UnityEngine.CombineInstance> a3;
	...
	static public int ForEach(IntPtr l) {
		try {
			System.Collections.Generic.List<UnityEngine.CombineInstance> self=(System.Collections.Generic.List<UnityEngine.CombineInstance>)checkSelf(l);
			System.Action<UnityEngine.CombineInstance> a1;
			LuaDelegation.checkDelegate(l,2,out a1);
			self.ForEach(a1);
			return 0;
		}
	...
	static public int Insert(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			UnityEngine.CombineInstance a2;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<UnityEngine.CombineInstance> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<UnityEngine.CombineInstance>))){
				System.Collections.Generic.List<UnityEngine.CombineInstance> self=(System.Collections.Generic.List<UnityEngine.CombineInstance>)checkSelf(l);
				System.Comparison<UnityEngine.CombineInstance> a1;
				LuaDelegation.checkDelegate(l,2,out a1);
				self.Sort(a1);
				return 0;
			}
			else if(matchType(l,argc,2,typeof(IComparer<UnityEngine.CombineInstance>))){
				System.Collections.Generic.List<UnityEngine.CombineInstance> self=(System.Collections.Generic.List<UnityEngine.CombineInstance>)checkSelf(l);
				System.Collections.Generic.IComparer<UnityEngine.CombineInstance> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				return 0;
			}
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<UnityEngine.CombineInstance> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				return 0;
			}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"ListCombineInstance");
		addMember(l,Add);
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<UnityEngine.CombineInstance>));
	}
}
