...
public class Lua_System_Collections_Generic_List_1_UnityEngine_GameObject : LuaObject {
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int constructor(IntPtr l) {
		try {
			int argc = LuaDLL.lua_gettop(l);
			System.Collections.Generic.List<UnityEngine.GameObject> o;
			if(argc==1){
				o=new System.Collections.Generic.List<UnityEngine.GameObject>();
				pushValue(l,o);
				return 1;
			}
			else if(matchType(l,argc,2,typeof(IEnumerable<UnityEngine.GameObject>))){
				System.Collections.Generic.IEnumerable<UnityEngine.GameObject> a1;
				checkType(l,2,out a1);
				o=new System.Collections.Generic.List<UnityEngine.GameObject>(a1);
				pushValue(l,o);
				return 1;
			}
	...
	static public int BinarySearch(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				UnityEngine.GameObject a1;
				checkType(l,2,out a1);
				System.Collections.Generic.IComparer<UnityEngine.GameObject> a2;
				...
				System.Collections.Generic.IComparer<UnityEngine.GameObject> a4;
	...
	static public int FindIndex(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Predicate<UnityEngine.GameObject> a3;
	...
	static public int InsertRange(IntPtr l) {
		try {
			...
			System.Int32 a1;
			checkType(l,2,out a1);
			System.Collections.Generic.IEnumerable<UnityEngine.GameObject> a2;
			checkType(l,3,out a2);
	...
	static public int Sort(IntPtr l) {
		try {
			...
			if(argc==1){
			...
			else if(matchType(l,argc,2,typeof(System.Comparison<UnityEngine.GameObject>))){
				System.Collections.Generic.List<UnityEngine.GameObject> self=(System.Collections.Generic.List<UnityEngine.GameObject>)checkSelf(l);
				System.Comparison<UnityEngine.GameObject> a1;
				LuaDelegation.checkDelegate(l,2,out a1);
				self.Sort(a1);
				return 0;
			}
			else if(matchType(l,argc,2,typeof(IComparer<UnityEngine.GameObject>))){
				System.Collections.Generic.List<UnityEngine.GameObject> self=(System.Collections.Generic.List<UnityEngine.GameObject>)checkSelf(l);
				System.Collections.Generic.IComparer<UnityEngine.GameObject> a1;
				checkType(l,2,out a1);
				self.Sort(a1);
				return 0;
			}
				...
				System.Int32 a2;
				checkType(l,3,out a2);
				System.Collections.Generic.IComparer<UnityEngine.GameObject> a3;
				checkType(l,4,out a3);
				self.Sort(a1,a2,a3);
				return 0;
			}
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(System.Collections.Generic.List<UnityEngine.GameObject>));
	}
}
