...
#region Language
    ...
    public void OnEnable()
    {
        ...
        picker = Resources.Load<Texture2D>("Director_PickerIcon");
    }
    ...
    protected void AddThemeToCamera(Texture2D theme, Camera camera)
    {
        ...
        {
            UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(camera.gameObject, "Assets/Tools/Cinema Suite/Cinema Themes/Editor/CinemaThemesWindow.cs (311,13)", "ColorCorrectionLut");
        }
