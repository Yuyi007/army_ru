...
namespace CinemaDirector
{
    ...
    public static class AnimationCurveHelper
    {
        ...
        {
#if PROFILE_FILE
            Profiler.BeginSample("AnimationCurveHelper.AddKey");
#endif // PROFILE_FILE
            if (curve.length == 0)
            {
#if PROFILE_FILE
        ...
        {
#if PROFILE_FILE
            Profiler.BeginSample("AnimationCurveHelper.MoveKey");
#endif // PROFILE_FILE
        ...
        {
#if PROFILE_FILE
            Profiler.BeginSample("AnimationCurveHelper.RemoveKey");
#endif // PROFILE_FILE
        ...
        {
#if PROFILE_FILE
            Profiler.BeginSample("AnimationCurveHelper.SetKeyRightLinear");
#endif // PROFILE_FILE
        ...
        {
#if PROFILE_FILE
            Profiler.BeginSample("AnimationCurveHelper.SetKeyLeftLinear");
#endif // PROFILE_FILE
            Keyframe kf = curve[index];
