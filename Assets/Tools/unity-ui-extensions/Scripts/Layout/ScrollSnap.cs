...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ScrollSnap : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        // 2016-4-27 lt: apply modifications
        public PageSnapChange onPageChange;
        ...
        void Init()
        {
            ...
            if (listContainerRectTransform == null)
        ...
        public void FirstScreen()
        {
            ...
            {
                lerp = true;
				if (pageAnchorPositions.Length > 0) {
					lerpTarget = pageAnchorPositions [0];
					ChangePage (0);
				}
            }    
        }
        ...
        {
            if (0 <= page && page < pages && page < pageAnchorPositions.Length)
            {
                lerp = true;
...
#region Interfaces
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (useFastSwipe)
            {
                ...
                {
                    lerp = true;
					Debug.Log (pageAnchorPositions.Length);
