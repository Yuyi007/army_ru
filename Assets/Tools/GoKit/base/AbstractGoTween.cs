...
public class AbstractGoTween
{
	...
	/// technically, this should be marked as internal
	/// </summary>
	public virtual List<AbstractTweenProperty> allTweenProperties() {
		return null;
	}
	...
	public virtual void destroy()
	{
        ...
        this._onInit = null;
        this._onBegin = null;
        this._onIterationEnd = null;
        this._onIterationStart = null;
        this._onUpdate = null;
	}
	...
	/// </summary>
	public virtual void goTo( float time, bool skipDelay) {
	}
    ...
    public virtual void clearDidInitFlag() {}
	public virtual void prepareAllTweenProperties() {}
