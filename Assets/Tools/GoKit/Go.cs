...
public class Go : MonoBehaviour
{
    ...
    private List<AbstractGoTween> _tweenList = new List<AbstractGoTween>();
    ...
    public static Go instance
    {
        get
        {
            ...
            if (!_instance && !_applicationIsQuitting)
            {
                ...
                var go = GameObject.Find("/GoKit") ?? new GameObject("GoKit");
                _instance = go.GetComponent<Go>() ?? go.AddComponent<Go>();
            }
    ...
    // 2016-6-9 lt: 
    // destroy the go instance, for garbage collection to take advantage of
    public static void destroyAll()
    {
        ...
        _tweens = new List<AbstractGoTween>();
