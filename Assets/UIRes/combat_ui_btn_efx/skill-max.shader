...
////// Lighting:
                ...
                float2 node_8866 = (i.uv0+(node_3902.g*_speed01)*float2(-1,-1));
                float4 _tex01_var = tex2D(_tex01,TRANSFORM_TEX(node_8866, _tex01));
                float2 node_142 = (i.uv0+(node_3902.g*_speed02)*float2(-1.5,-1));
